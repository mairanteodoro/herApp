...
class TopLevelWin:
    ...
    def __init__(self, master):
        ...
        self.button1 = tk.Button(self.frame, text='Analyze radial profiles', width=25,
                                 command=lambda: os.system('python herApp_mod1.py'))
        self.button1.pack()

        self.button2 = tk.Button(self.frame, text='Analyze iso-velocity images', width=25,
                                 command=lambda: os.system('python herApp_mod2.py'))
        self.button2.pack()
        #
        ...
        self.quitbutton = tk.Button(self.frame, text='Quit herApp', width=25,
