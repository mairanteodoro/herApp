...
class MainApplication(tk.Frame):
    ...
    def __init__(self, parent):
        ...
        # defining the parent
        self.parent = parent
        self.parent.title('Herschel App - Radial line profile module')
    ...
    def printMessage(self):
        if (self.data != None):
            ...
            tkMessageBox.showinfo("Herschel App", "Data have been loaded from:\n\n" + self.fullPath)
        else:
            # warn user there is no data loaded
            tkMessageBox.showinfo("Herschel App", "\nData have not been loaded yet.")
    ...
    def confirmQuit(self):
        answer = tkMessageBox.askyesno(title="Herschel App", message="\nDo you really want to quit?")
        if (answer):
            self.quit()
    ...
    def readData(self):
        ...
        home = expanduser("~")
        initialdir = home #'/Volumes/Kerberos/DATA/ETC/her/TEDS_CUBE/NEW/'
    ...
    def confirmClearData(self):
        ...
        if (answer):
            ...
            tkMessageBox.showwarning(title="Herschel App", message="\nData has been deleted.")
    ...
    def radialProfile(self, data, slitWidth=None, radius=None, pa=None):
            ...
            profile = herMeasure.profile(data, radius, pa, slitWidth)
            ionData1 = herData.get(profile, key='lineID', value=self.lineID) # retrieving the data for the ion
