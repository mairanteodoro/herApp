...
class MainApplication(tk.Frame):
    ...
    def __init__(self, parent):
        ...
        # defining the parent
        self.parent = parent
        self.parent.title('Herschel App - iso-velocity images module')
    ...
    def isoVelImage(self):
            ...
            import herData
            # for the App, dataList must have the full path to the FITS files
            data = herData.read(self.dataList, self.curVel, self.curVel)
            ionData = herData.get(data, key='lineID', value=self.lineID) # retrieving the data for the ion
